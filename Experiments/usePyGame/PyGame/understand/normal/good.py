...
window = pygame.display.set_mode((area_width * 2, area_width),pygame.RESIZABLE | pygame.SCALED)
...
while run:
    ...
    speed = ((0 if dist_front <= max_speed else keys[pygame.K_UP]) - (
        0 if dist_back <= max_speed else keys[pygame.K_DOWN])) * max_speed
    ...
    pygame.draw.circle(window, (255, 0, 0), (player_x, player_y), 10)
